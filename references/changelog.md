...
This changelog documents significant infrastructure changes, upgrades, and maintenance activities performed on the homelab environment. It serves as an operational reference for troubleshooting, auditing, and understanding the evolution of the system.
...
- **Component**: Proxmox / Kubernetes / Network / Services / etc.
- **Description**: Brief summary of what changed
- **Impact**: What was affected (down time, performance, security, etc.)
...
- **Description**: Created OPNsense VM (VMID 128) to serve as primary firewall, NAT gateway, and VLAN router. Configured WAN interface with DHCP from ISP and LAN interface on internal k8s network.
...
- **Component**: Network / Proxmox
- **Description**: Configured LACP bond0 using 4x Intel Ethernet NICs for link aggregation. Bridge vmbr0 created with VLAN awareness enabled for trunking multiple VLANs over single uplink.
...
*Changelog maintained as part of homelab documentation. Add entries for significant changes to maintain operational awareness.*
